...
function print_usage {
  ...
  echo "Example:"
  echo
  echo "  gruntwork-install --repo https://github.com/terraform-modules-krish/bash-commons --module-name bash-commons --tag v0.0.1 --module-param dir=/opt/gruntwork/bash-commons"
}
