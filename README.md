...
* Automated tests are in the [test](https://github.com/terraform-modules-krish/bash-commons/blob/v0.0.5/test) folder.
...
* If you ever need to build a new Docker image, the `Dockerfile` is in the [.circleci folder](https://github.com/terraform-modules-krish/bash-commons/blob/v0.0.5/.circleci):
